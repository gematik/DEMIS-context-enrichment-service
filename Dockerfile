...
COPY --chown=$USERID:$GROUPID target/context-enrichment-service.jar /app.jar
...
LABEL de.gematik.vendor="gematik GmbH" \
      ...
      de.gematik.app="context-enrichment-service" \
      de.gematik.git-repo-name="https://gitlab.prod.ccs.gematik.solutions/git/demis/services/context-enrichment-service.git" \
