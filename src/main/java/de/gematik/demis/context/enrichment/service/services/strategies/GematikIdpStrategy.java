...
import static de.gematik.demis.context.enrichment.service.utils.enums.TokenClaimsEnum.PROFESSION_OID;
...
@Service
public class GematikIdpStrategy extends TokenProcessStrategy {

  @Override
  List<TokenClaimsEnum> getNeededClaims() {
    return List.of(AZP, PROFESSION_OID, ACCOUNT_TYPE, SUB, USERNAME, ACCOUNT_SOURCE);
  }
  ...
  public ProvenanceAgentComponent createAgent(Map<String, Object> claims) {
    ...
    agentBuilder.addOrganizationExtension(claims.get(PROFESSION_OID.getName()).toString());
    ...
    agentBuilder.setAccountIdentifierSystem(GEMATIK_IDENTIFIER_SYSTEM);
